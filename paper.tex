...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  	...
  	\section{Introduction}
		Datasets such as corpora are an important part in training and evaluation of an intelligent systems. A corpus is a structured collection of data of one or multiple modalities. Those modalities are for example written text, audio or video recordings of an experiment. Corpora which incorporate multiple modalities are called multimodal corpora. This paper will give a short overview over three of them. The first one being the BAS SmartKom Corpus with the focus set on human computer interaction. The second corpus is the Callas Expressivity Corpus where cross-cultural differences in gestures is the motivation for the creation. The last corpus, which is the Bielefeld Speech and Gesture Alignment Corpus, is about speech and gestures in a face to face conversation.
